...
{
return confirm("Are you sure you want to delete this patient and all his scans and lesions?")
}
</script>
<?php
...
if ($user_admin_access == 'Y') {
 ...
 echo "<tr><td>&nbsp;</td><td ><input name=\"Submit\" value=\"Update Patient\" type=\"submit\"></td></form>";
 
 echo "<td><form action=\"patientdelete.php\" method=\"post\" onsubmit=\"return validateForm2()\">";
 echo "<input type=\"hidden\" name=\"patient_id\" value=\"$patient_id\">";
...
<tbody>
<?php
echo "<form action=\"http://$db_server/team/teamresponse.php\" onsubmit=\"return true\" target=\"_blank\" method=\"get\">";
echo "<tr><td align=center width=\"25%\"><input type=\"image\" src=\"responsethumb.png\" height=55 width=55 alt=\"Submit button\"></td>";
echo "<input type=\"hidden\" name=\"patient_id\" value=\"$patient_id\">";
...
<?php
echo "<form action=\"http://$db_server/team/graphpatient.php\" onsubmit=\"return true\" target=\"_blank\" method=\"get\">";
echo "<td align=center width=\"25%\"><input type=\"image\" src=\"charts.jpg\" height=55 width=55 alt=\"Submit button\"></td>";
echo "<input type=\"hidden\" name=\"patient_id\" value=\"$patient_id\">";
echo "<input type=\"hidden\" name=\"patient_name\" value=\"$patient_name\">";
echo "<input type=\"hidden\" name=\"user_name\" value=\"$user_name\">";
echo "<input type=\"hidden\" name=\"user_teamid\" value=\"$user_teamid\">";
...
<?php
echo "<form action=\"scans.php\" onsubmit=\"return true\" method=\"get\">";
echo "<td align=center width=\"25%\"><input type=\"image\" src=\"icon-scans.png\" height=55 width=55 alt=\"Submit button\"></td>";
echo "<input type=\"hidden\" name=\"patient_id\" value=\"$patient_id\">";
echo "<input type=\"hidden\" name=\"patient_name\" value=\"$patient_name\">";
echo "<input type=\"hidden\" name=\"user_name\" value=\"$user_name\">";
?>
...
<?php
echo "<form action=\"compareimages.php\"  onsubmit=\"return true\" method=\"get\">";
echo "<td align=center width=\"25%\"><input type=\"image\" src=\"icon-twodoctors.png\" height=55 width=55 alt=\"Submit button\"></td>";
echo "<input type=\"hidden\" name=\"patient_id\" value=\"$patient_id\">";
echo "<input type=\"hidden\" name=\"patient_name\" value=\"$patient_name\">";
echo "<input type=\"hidden\" name=\"user_name\" value=\"$user_name\">";
?>
...
<table style="margin: auto;" border="0" cellpadding="2" cellspacing="2" width="50%">
<tbody>
<tr><td align="center" width=25%>Response</td><td align="center" width=25%>Graph Scans</td><td align="center" width=25%>Scans</td><td align="center" width=25%>Compare Images</td></tr>

<?php
if ($up == 'ok') {
	echo "<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>";
 echo "<tr><td align=\"center\" width=25%></td><td align=\"center\" width=25%>$patient_id Updated</td><td align=\"center\" width=25%></td><td align=\"center\" width=25%></td></tr>";
}
$audit_type = 'v1';
include 'auditlog.php';

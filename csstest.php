...
<link rel="stylesheet" type="text/css" href="cssmenu/resets.css" />
...
<body>
	<div id="page-wrap">
	    <a href="http://css-plus.com/2010/06/create-a-search-form-with-css3-and-jquery/" id="post-return">Return to post</a>
		<div id="content">
            <h2>jQuery sub-navigation with CSS fall-back</h2>
			<ul id="nav">
            	<li><a href="#">Home</a></li>
                <li><a href="#">Products and Patients</a>
					<ul class="child">
